// gk-managed:{"events":["permission.asked","permission.replied","session.compacted","session.created","session.deleted","session.error","session.idle","session.status","session.updated","tool.execute.after","tool.execute.before"],"executable":"/Users/DRomanowski/Library/Application Support/GitKrakenCLI/gk"}
...
const EXECUTABLE = "/Users/DRomanowski/Library/Application Support/GitKrakenCLI/gk";
